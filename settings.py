...
APP_HOME = "/web/smart_surescripts_connector"

# Indivo
INDIVO_SERVER_LOCATION = {'scheme': 'http', 'host': 'localhost', 'port': '7000'}
INDIVO_UI_SERVER_BASE = 'http://localhost:7001'
INDIVO_SERVER_OAUTH = {'consumer_key': 'smart-bg-app', 'consumer_secret': 'smartapp-secret'}
...
MIDDLEWARE_CLASSES = (
    ...
    'indivo_hospital_connector.connector.middlewares.error.Error'
)
